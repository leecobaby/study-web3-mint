...
import { useConnectors, useAccount, useNetwork, useTransaction } from '@starknet-react/core'
import { createCssElement } from '../utils/style'

// Constants
const TWITTER_HANDLE = 'leeco'
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`

window.chainLogo = ethLogo
...
export const App = () => {
  ...
  // const { data, error } = useTransaction({ hash, watch: true })
  ...
  useEffect(() => {
    let cssEl = createCssElement('/style/starknet-nft.css')
    return () => {
          ...
          <header>
            <div className="left">
              ...
              <p className="subtitle">
                This is a sample DAPP which alows you to mint an NFT on StarkNet!
              </p>
            </div>
            {/* Display a logo and wallet connection status*/}
            <div className="right">
              <img alt="Network logo" className="logo" src={window.chainLogo} />
              {status === 'connected' ? (
